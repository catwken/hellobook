...
新开发的受需要至少至少一周才能再次练习。在他可以吞入一个拳头之前，即使使用了很多的润滑剂，他的菊穴也会有极小的裂口。
...
- 按摩或扩张第二括约肌以协助肛道（第二括约肌）准备接受手的插入。    
- 抽插手指，逐步增加以插入四个手指。
- 弯曲并摸索以确定进入第二括约肌和乙状结肠的的通道位置。
...
- 反复进行进入第三括约肌的准备和练习动作
- 使横结肠的位置移到一个较直的方向上（感觉不到肠壁的阻挡）
- 如同第二部一样，穿过第三括约肌

#### 事后护理

对于深入扩张，无需特别的护理。通常受的开发程度都很高了，而且..

#### 提示

- 当乙状结肠和横结肠之间的括约肌打开后，S形弯曲还是需要大量时间才能通过的
...
- 跟受讨论拳需要保持在直肠还是深入过第二括约肌.
- 让攻的手找到一个最舒适的保持位置，一般是胳膊上最细的位置

##### 3. 把更多的手指插入肛门

- 保持一只手已经插入的情况下，在手腕附近开始插入一个手指
- 增加另外一个手指，并且打开手指做剪刀运动，以扩张肛门
- 插入全部四个手指，一直插入到拇指根部
...
即使适当的使用了润滑剂，受的肛门和肠道也会有很多微小的撕裂。所以想要再次训练的话，需要休息几天才行。

#### 提示

- 当插入第一个手到手腕后，让手指绕着菊洞360度转动有助于扩张
- 当通过插入双拳这一关后，就可以解锁拳攻弯曲主动不用顾忌受的双拳交玩法了。
...
每次常规训练应逐渐使用更大的玩具。下面的链接可以在开始扩张前帮助你获得一些准备和购买新玩具的建议：

- [Art & Science: Toys](as_toys.html) -适当的使用玩具可以在深度扩张时帮助你免受伤害。 这些文章展示了如何在扩张训练和玩耍过程中使用玩具。
- 推荐和反馈 - 我开了一个tumblr账号记录我的玩具和愿望清单。你可以通过这个来考虑我这些年扩肛经历中使用过的假阳具和肛塞 。
- References / See Also
